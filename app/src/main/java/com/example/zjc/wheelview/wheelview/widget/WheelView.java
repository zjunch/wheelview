 ...
 */
package com.example.zjc.wheelview.wheelview.widget;
...
import com.example.zjc.wheelview.wheelview.adapter.BaseWheelAdapter;
import com.example.zjc.wheelview.wheelview.adapter.SimpleWheelAdapter;
import com.example.zjc.wheelview.wheelview.common.WheelConstants;
import com.example.zjc.wheelview.wheelview.common.WheelViewException;
import com.example.zjc.wheelview.wheelview.graphics.DrawableFactory;
import com.example.zjc.wheelview.wheelview.util.WheelUtils;
    ...
    private void refreshTextView(int position, int curPosition, View
        ...
        if (curPosition == position) { // 选中
            ...
            float textSize = mStyle.selectedTextSize != -1 ? mStyle
                    ...
                    defTextSize);
            setTextView(itemView, textView, Color.rgb(255,143,23), textSize, 1.0f);
        } else {    // 未选中
