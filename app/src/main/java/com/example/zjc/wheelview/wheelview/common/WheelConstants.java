 ...
 */
package com.example.zjc.wheelview.wheelview.common;
...
public class WheelConstants {
     ...
     * common皮肤默认背景
     */
    public static final int WHEEL_SKIN_COMMON_BG = Color.parseColor("#ffffff");
     ...
     * 滚轮默认文本颜色
     */
    public static final int WHEEL_TEXT_COLOR = Color.rgb(143,143,143);
     ...
     * 滚轮默认文本透明度
     */
    public static final float WHEEL_TEXT_ALPHA = 0.5f;

    /**
     * common皮肤默认选中框颜色
     */
    public static final int WHEEL_SKIN_COMMON_COLOR = Color.parseColor("#ffffff");

    /**
     * common皮肤选中框divider颜色
     */
    public static final int WHEEL_SKIN_COMMON_DIVIDER_COLOR = Color.parseColor("#dadada");

    /**
     * common皮肤左右边框颜色
     */
    public static final int WHEEL_SKIN_COMMON_BORDER_COLOR = Color.parseColor("#ffffff");
